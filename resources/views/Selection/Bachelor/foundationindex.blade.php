...
<div class="row">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('bachelor-foundation-selection.index') }}" method="GET">
                @csrf
                <div class="row g-3">
    ...
    @if ((isset($foundationlists) && $foundationlists->isNotEmpty()))
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="num-rows" class="form-control" min="1" max="{{ count($foundationlists)}}" placeholder="Enter number of rows" />
            </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($foundationlists as $applicant)
                        <tr>
                            <td>
                                <div class="form-check">
                            ...
                            <td>{{ isset($foundationlists) && $foundationlists->contains($applicant) ? 'NTA Level 6' : 'Form Six' }}</td>
                            <td> 
                                @php
