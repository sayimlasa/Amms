                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form method="POST" action="{{ route('diploma-requirements.store') }}">
                                    @csrf
                                    <div class="row g-4">
                                        <!-- Programme Selection -->
                                        ...
                                        <div class="col-xxl-12 col-md-12" id="certificate_fields" style="display: none;">
                                            <div>
                                                <label for="subject_course" class="form-label">Subjects or Courses</label>
                                                <textarea class="form-control" id="subject_course" name="subject_course" rows="4"></textarea>
                                        ...
                                        <div class="col-xxl-6 col-md-6 form-six-fields" style="display: none;">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="min_advance_pass" name="min_advance_pass">
                                        ...
                                        <div class="col-xxl-6 col-md-6 form-six-fields" style="display: none;">
                                            <div>
                                                ...
                                                <input type="number" class="form-control" id="min_subsidiary_pass" name="min_subsidiary_pass">
                                                <small class="text-muted">Only check on principle subjects.</small>
                                            </div>
                                        </div>
