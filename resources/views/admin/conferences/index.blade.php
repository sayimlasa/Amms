          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Conference List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>{{$conference->is_published == 1 ? 'Yes' : 'No' }}</td>
                    <td>{{$conference->no}}</td>
                    <td>
                    <a class="btn btn-xs btn-primary" href="{{route('conferences.show', $conference)}}">{{'view'}}</a>
                       
                    <a class="btn btn-xs btn-info" href="{{route('conferences.edit', $conference)}}">{{'edit'}}</a>
