        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('ac-assets.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="warranty_expiry_date" value="{{ old('warranty_expiry_date') }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="derivery_note_date" value="{{ old('derivery_note_date') }}">
                             ...
                             <div class="col-md-6">
                            <label for="invoice_number_attachment" class="form-label">Invoice Attachment</label>
                            <input type="file" name="invoice_number_attachment" class="form-control">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="delivery_note_attachment" class="form-label">Delivery Note Attachment</label>
                            <input type="file" name="delivery_note_attachment" class="form-control">
                        </div>
                        <div class="col-md-6">
