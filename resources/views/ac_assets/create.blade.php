                 ...
                 <div class="card-body">
                     ...
                     <form action="{{ route('ac-assets.store') }}" method="POST" class="row g-3">
                         ...
                         <div class="col-md-6">
                             ...
                             <input type="text" class="form-control" name="warranty_number"
                         ...
                         <div class="col-md-6">
                             ...
                             <input type="text" class="form-control" name="derivery_note_number"
                                 value="{{ old('derivery_note_number') }}">
                         </div>

                         <div class="col-md-6">
                             <label for="derivery_note_date" class="form-label">Delivery Note Date</label>
                             <input type="date" class="form-control" name="derivery_note_date"
                                 value="{{ old('derivery_note_date') }}">
                         </div>
                         ...
                         <div class="col-md-6">
                             ...
                             <input type="text" class="form-control" name="justification_form_no"
                                 value="{{ old('justification_form_no') }}">
                         </div>
