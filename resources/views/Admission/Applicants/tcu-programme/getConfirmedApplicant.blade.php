        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('getconfirmed.arusha.get') }}" method="GET">
            ...
            <tbody>
                @foreach ($applicant as $applicantData)
                    <tr>
                        ...
                        <td>{{ empty($applicantData['f6indexno']) ? $applicantData['diploma'] : $applicantData['f6indexno'] }}</td>
                        <td>
                            @if($applicantData['f6indexno']) A @endif
                            @if($applicantData['diploma']) D @endif
                        </td>
