                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h6 class="mb-0 flex-grow-1">Edit songea Programme</h6>
                        </div>

                        <div class="card-body">
                            <div class="live-preview">
                                <form method="POST" action="{{ route('programme.songea.update', $program->id) }}">
                                    @csrf
                                    <div class="row g-4">
                                        <!-- Program ID -->
                                        ...
                                        <!-- Programme Selection -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="program_selection" class="form-label">songea Programme</label>
                                            <select id="programmeSelect" name="songea_program" class="form-control select2">
                                        ...
                                        <!-- Arusha Program ID -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="arusha_program_id" class="form-label">songea Program ID</label>
                                            <input type="text" class="form-control" id="arusha_program_id" name="songea_program_id" value="{{ $program->songea_program_id }}" readonly required>
                                        </div>
