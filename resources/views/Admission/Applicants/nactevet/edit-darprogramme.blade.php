                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form method="POST" action="{{ route('programme.dar.update', $program->id) }}">
                                    @csrf
                                    <div class="row g-4">
                                        <!-- Program ID -->
                                        ...
                                        <!-- Programme Selection -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="program_selection" class="form-label">Dar Programme</label>
                                            <select id="programmeSelect" name="dar_program" class="form-control select2">
                                        ...
                                        <!-- Arusha Program ID -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="arusha_program_id" class="form-label">Dar Program ID</label>
                                            <input type="text" class="form-control" id="arusha_program_id" name="dar_program_id" value="{{ $program->dar_program_id }}" readonly required>
                                        </div>
