                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h6 class="mb-0 flex-grow-1">Edit Arusha Programme</h6>
                        </div>

                        <div class="card-body">
                            <div class="live-preview">
                                <form method="POST" action="{{ route('programme.arusha.update', $program->id) }}">
                                    @csrf
                                    <div class="row g-4">
                                        <!-- Program ID -->
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="arusha_program_id" name="arusha_program_id" value="{{ $program->iaa_program_id }}" readonly required>
                                        </div>
