...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <form action="{{ route('programme.arusha.store') }}" method="GET">
            ...
            <table id="" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>Nta</th>
                        <th>IAA Programme</th>
                        <th>IAA ProgrammeId</th>
                        <th></th>
                    </tr>
                </thead>
                @php $count = 0 @endphp
                <tbody>
                    @foreach ($nacteprogram as $program)
                    <tr>
                        <td>{{ ++$count }}</td>
                        ...
                        <td>
                            <a class="dropdown-item" href="{{ route('programme.arusha.edit', $program->id) }}">
