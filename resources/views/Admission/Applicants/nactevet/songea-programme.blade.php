...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <form action="{{ route('programme.songea.store') }}" method="GET">
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-4">
                <h6 class="mb-0">List of songea Programme</h6>
            </div>
        </div>
        ...
        <div class="table-responsive mt-3">
            <table id="" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                ...
                @php $count = 0 @endphp
                <tbody>
                    @foreach ($nacteprogramsongea as $program)
                    <tr>
                        <td>{{ ++$count }}</td>
                        ...
                        <td>
                            <a class="dropdown-item" href="{{ route('programme.songea.edit', $program->id) }}">
