        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('verification.babati.store') }}" method="POST">
                            @csrf
...
<script>
    $(document).ready(function() {
        ...
        // Initialize DataTable with export buttons and customized language for pagination
        $('#studentTable').DataTable({
            dom: 'Bfrtip', // Add buttons to the DataTable
            buttons: [
                'copy', 'csv', 'excel', 'pdf' // Includes Excel, CSV, and other formats
            ],
            language: {
                info: "Showing _START_ to _END_ of _TOTAL_ entries",  // Customize the pagination info message
                infoEmpty: "Showing 0 to 0 of 0 entries", // For when there is no data
                infoFiltered: "(filtered from _MAX_ total entries)" // For filtered results
            }
        });
    });
</script>
