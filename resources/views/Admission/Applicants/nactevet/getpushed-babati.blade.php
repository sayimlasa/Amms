            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>List of Pushed Applicants</span>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('getpushedlist.get.babati') }}" method="POST">
                            @csrf
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-4">
                <h6 class="mb-0">List of Pushed Applicants</h6>
            </div>
        </div>
...
<!-- DataTables Buttons Plugin CSS and JS -->
...
<script>
    $(document).ready(function() {
        ...
        // Initialize DataTable with export buttons (CSV, Excel, PDF)
