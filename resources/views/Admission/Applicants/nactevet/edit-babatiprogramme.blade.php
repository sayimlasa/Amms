                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h6 class="mb-0 flex-grow-1">Edit babati Programme</h6>
                        </div>

                        <div class="card-body">
                            <div class="live-preview">
                                <form method="POST" action="{{ route('programme.babati.update', $program->id) }}">
                                    @csrf
                                    <div class="row g-4">
                                        <!-- Program ID -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="program_id" class="form-label">Program ID</label>
                                            <input type="text" class="form-control" id="program_id" name="program_id" value="{{ $program->program_id }}" readonly>
                                        </div>

                                        <!-- NACTEVET Programme Name -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="program_name" class="form-label">Nactevet Programme Name</label>
                                            <input type="text" class="form-control" id="program_name" name="program_name" value="{{ $program->program_name }}" readonly>
                                        </div>
                                        ...
                                        <!-- Programme Selection -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="program_selection" class="form-label">babati Programme</label>
                                            <select id="programmeSelect" name="babati_program" class="form-control select2">
                                        ...
                                        <!-- Arusha Program ID -->
                                        <div class="col-xxl-3 col-md-6">
                                            <label for="arusha_program_id" class="form-label">babati Program ID</label>
                                            <input type="text" class="form-control" id="arusha_program_id" name="babati_program_id" value="{{ $program->babati_program_id }}" readonly required>
                                        </div>
