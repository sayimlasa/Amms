    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('certificate.four') }}" method="GET">
...
<div class="card">
    <div id="checkbox-message" class="alert alert-warning mt-3" style="display: none;">
    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-sm-4 text-end">
                ...
                <form action="{{ route('applicants-selection.store') }}" method="POST" id="save-form" style="display: none;">
                    @csrf
            ...
            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                            $programme = \App\Models\Programme::find($s->campus);
                            @endphp
