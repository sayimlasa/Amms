                                    ...
                                    <div class="row g-4">
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="iaa_code" name="iaa_code" placeholder="IA01" oninput="capitalizeAllLetters(this)" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                <label for="tcu_code" class="form-label">TCU Code</label>
                                                <input type="text" class="form-control" id="tcu_code" name="tcu_code" placeholder="TC01" oninput="capitalizeAllLetters(this)" >
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                <label for="nacte_code" class="form-label">NACTE Code</label>
                                                <input type="text" class="form-control" id="nacte_code" name="nacte_code" placeholder="NA01" oninput="capitalizeAllLetters(this)" >
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                <label for="name" class="form-label">Name</label>
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Bachelor Of Computer Science" oninput="capitalizeOnlyFirstLetter(this)" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                <label for="short" class="form-label">Short</label>
                                                <input type="text" class="form-control" id="short" name="short" placeholder="BCS" oninput="capitalizeAllLetters(this)" required>
                                            </div>
                                        </div>
