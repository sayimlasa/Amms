                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h6 class=" mb-0 flex-grow-1">Edit Country</h6>
                        </div><!-- end card header -->
                        <div class="card-body">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="{{$country->name}}" oninput="capitalizeOnlyFirstLetter(this)" required>
                                            </div>
                                        </div>
                                        <!-- Submit Button -->
                                        <div class="col-12">
