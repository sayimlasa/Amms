...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <a href="{{route('application-levels.index')}}" class="btn btn-info">Back</a>
            </div>
        </div>
    </div>
</section>
<div class="card">
    <div class="card-header">
        <h6 class="mb-0">Level Details</h6>
    </div>
    <div class="card-body">
    <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" disabled="disabled" {{ $applicationLevel->active ? 'checked' : '' }}>
                        </td>
                    </tr>
                </tbody>
            </table>
