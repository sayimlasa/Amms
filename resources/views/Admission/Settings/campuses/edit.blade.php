                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="code" name="code" value="{{$campus->code}}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="{{$campus->name}}" oninput="capitalizeOnlyFirstLetter(this)" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <select class="form-control select2" id="country_id" name="country_id" required>
                                                    ...
                                                    <option value="{{$country->id}}" {{ old('country_id', $campus->country->id) == $country->id ? 'selected' : '' }}>{{$country->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <select class="form-control select2" name="region_state_id" id="region_id" required>
                                                     @if ($campus->region)
                                                    <option value="{{ $campus->region->id }}" selected>{{ $campus->region->name }}</option>
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                ...
                                                <select class="form-control select2" name="district_id" id="district_id" required>
                                                    @if ($campus->district)
                                                    <option value="{{ $campus->district->id }}" selected>{{ $campus->district->name }}</option>
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="active" name="active" value="1" {{ $campus->active || old('active', 0) === 1 ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
            ...
            if (country_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                       ...
                       var selectedRegionId = '{{ $campus->region_state_id ?? '
                        ' }}';
                        if (selectedRegionId) {
            ...
            if (region_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // Set the selected region for editing
                       var selectedDistrictId = '{{ $campus->district_id ?? '
                        ' }}';
