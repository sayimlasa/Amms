                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h6 class=" mb-0 flex-grow-1">New Employer</h6>
                        </div><!-- end card header -->
                        <div class="card-body">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Institute Of Accountancy Arusha" oninput="capitalizeOnlyFirstLetter(this)" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-3 col-md-3">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="address" name="address" placeholder="P.O.Box xxxx, Arusha" oninput="capitalizeOnlyFirstLetter(this)"  required>
                                            </div>
                                        </div>
                                        <input type="hidden" name="emp_status_id" value="{{$status->id}}">
                                        <!-- Submit Button -->
                                        <div class="col-12">
                                            <div class="text-end">
